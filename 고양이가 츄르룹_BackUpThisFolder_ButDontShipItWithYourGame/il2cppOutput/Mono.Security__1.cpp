...
CATCH_013a:
	{// begin catch(System.Security.Cryptography.CryptographicException)
		...
		NullCheck(L_60);
		VirtualActionInvoker1< RSAParameters_t14B738B69F9D1EB594D5F391BDF8E42BA16435FF >::Invoke(15 /* System.Void System.Security.Cryptography.RSA::ImportParameters(System.Security.Cryptography.RSAParameters) */, L_60, L_61);
		IL2CPP_POP_ACTIVE_EXCEPTION(Exception_t*);
		goto IL_0158;
	}// end catch (depth: 1)
